...
export default defineConfig(({ mode }) => {
  ...
  // En production, pas de proxy - utiliser directement les URLs absolues
  if (mode === "production") {
    return {
      plugins: [react()],
      // Pas de configuration de serveur/proxy en production
      define: {
  ...
  // En développement, utiliser les proxies
